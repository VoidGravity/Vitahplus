...
<head>
    ...
    <!-- @vite(['resources/css/dashlite.css', 'resources/js/bundle.js', 'resources/js/scripts.js', 'resources/js/charts/gd-hospital.js']) -->
...
<body class="nk-body ui-rounder npc-default has-sidebar ">
    ...
    {{-- <script src="../../public/js/bundle.js?ver=3.2.3"></script> --}}
