...
<head>
    ...
    <!-- Page Title  -->
    <title>Members Profile Regular - Layout | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            <li><a class="active" href="html/pharmacy/members-profile-regular.html"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                                                            ...
                                                            <li><a href="html/pharmacy/members-profile-setting.html"><em class="icon ni ni-lock-alt-fill"></em><span>Security Settings</span></a></li>
                                                        </ul>
                                                    </div><!-- .card-inner -->
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg date-picker" id="birth-day" placeholder="Enter your birth day">
                                    </div>
                                </div>
                                <div class="col-12">
