...
<head>
    ...
    <!-- Page Title  -->
    <title>General settings | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="nk-block">
                                                    <form action="#" class="form-settings gy-3">
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="site-name">pharmacy Name</label>
                                                                    <span class="form-note">Specify the name of your pharmacy.</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="site-email">pharmacy Address</label>
                                                                    <span class="form-note">Specify the key of your pharmacy address</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="form-note">Copyright information of your pharmacy.</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="form-note">Describe your pharmacy information.</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            <li><a class="active" href="html/pharmacy/general-settings.html"><em class="icon ni ni-setting-alt-fill"></em><span>General</span></a></li>
                                                            <li><a href="html/pharmacy/member-settings.html"><em class="icon ni ni-account-setting"></em><span>Members</span></a></li>
