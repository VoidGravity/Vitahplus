...
<head>
    ...
    <!-- Page Title  -->
    <title>Attendence | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body ui-rounder npc-default has-sidebar ">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Attendence</h3>
                                    ...
                                    <div class="row gy-5">
                                        <div class="col-lg-12">
                                            <div class="nk-block-head">
                                                <div class="nk-block-head-content">
                                                    <h5 class="nk-block-title title">Add an attendence</h5>
                                                </div>
                                            </div><!-- .nk-block-head -->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="nk-block-head">
                                                <div class="nk-block-head-content">
                                                    <h5 class="nk-block-title title">Attendence List</h5>
                                                </div>
                                            </div><!-- .nk-block-head -->
                                            <div class="nk-block">
                                                        ...
                                                        <div class="card-inner p-0">
                                                            <div class="nk-tb-list nk-tb-ulist">
                                                                <div class="nk-tb-item nk-tb-head  bg-lighter">
                                                                    ...
                                                                    <div class="nk-tb-col tb-col-md"><span class="sub-text">Sign In</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span class="sub-text">Sign Out</span></div>
                                                                    <div class="nk-tb-col"><span class="sub-text">Stay Time</span></div>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-danger">9hr 0min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-primary">9hr 27min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-success">9hr 22min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-danger">8hr 55min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-warning">9hr 18min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-info">9hr 26min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-dark">9hr 25min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-success">9hr 20min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-warning">9hr 0min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col">
                                                                        <span class="badge badge-dim bg-gray">8hr 58min</span>
                                                                    </div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-1">
                                                                            <li>
    ...
    <!-- Edit Attendence-->
    <div class="modal fade" tabindex="-1" role="dialog" id="editAttendence">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Edit Attendence</h5>
                    <form action="#" class="mt-4">
                        <div class="row g-gs">
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Edit Attendence</a>
                                    </li>
                                    <li>
