...
<head>
    ...
    <!-- Page Title  -->
    <title>Stock report | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Stock Report</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                            <a data-bs-toggle="modal" href="#addStock" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                            <a data-bs-toggle="modal" href="#addStock" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Stock</span></a>
                                                                            ...
                                                                            <li>
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                                                        <div class="dropdown-head">
                                                                                            <span class="sub-title dropdown-title">Filter Stock</span>
                                                                                            <div class="dropdown">
                                                                                                ...
                                                                                                <div class="col-6">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <select class="form-select form-select-sm js-select2">
                                                                                                            <option value="out">Any Status</option>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Manufacturer Name</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">In Quantity(Box)</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Out Quantity(Box)</span></div>
                                                        <div class="nk-tb-col"><span>Stock(Box)</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <a href="#">
                                                                <div class="user-card">
                                                                    <div class="user-avatar bg-blue-dim">
                                                                        <span><em class="icon ni ni-home-fill"></em></span>
                                                                    </div>
                                                                    <div class="user-info">
                                                        ...
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-warning">Available</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <a href="html/pharmacy/medicine-details.html">
                                                                <span class="tb-product">
                                                                    <span class="title">Acetylaclic Acid</span>
                                                                </span>
                                                            </a>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-4">
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">In Quantity(Box)</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Out Quantity(Box)</label>
                                    <div class="form-control-wrap number-spinner-wrap">
                                        <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>
                                        <input type="number" class="form-control number-spinner" value="0">
                                        <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select">
                                            ...
                                            <option value="option_select_status">Out Of Stock</option>
                                        </select>
                                    </div>
                                </div>
                            </div><!--col-->
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Add Stock</a>
                                    </li>
                                    <li>
