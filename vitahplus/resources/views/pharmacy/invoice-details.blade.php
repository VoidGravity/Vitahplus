                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head">
                                    <div class="nk-block-between g-3">
                                        ...
                                        <div class="nk-block-head-content">
                                            <a href="html/pharmacy/invoice-list.html" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                            <a href="html/pharmacy/invoice-list.html" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                <div class="nk-block">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>24108054</td>
                                                                <td>Zimax - Group of Azithromycin</td>
                                                                <td>$40.00</td>
                                                                <td>5</td>
                                                                <td>$200.00</td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>23604094</td>
                                                                <td>Oxidon- Group of Domperidon</td>
                                                                <td>$131.25</td>
                                                                <td>1</td>
                                                                <td>$131.25</td>
                                                            </tr>
