                                                    ...
                                                    <form action="#" class="gy-3 form-settings">
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" class="form-control" id="site-copyright" value="921">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            ...
                                                            <li><a a class="active" href="html/pharmacy/email-settings.html"><em class="icon ni ni-lock-alt-fill"></em><span>E-mail</span></a></li>
