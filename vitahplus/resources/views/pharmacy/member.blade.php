...
<head>
    ...
    <!-- Page Title  -->
    <title>Member - Layout | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Members</h3>
                                        ...
                                        <div class="nk-block-head-content">
                                            ...
                                            <a href="html/pharmacy/add-member.html" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Member</span></a>
                                        </div><!-- .nk-block-head-content -->
                                                                            ...
                                                                            <li>
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                                                        <div class="dropdown-head">
                                                                                            <span class="sub-title dropdown-title">Filter Members</span>
                                                                                            <div class="dropdown">
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col"><span class="sub-text">Members</span></div>
                        ...
                        <div class="row g-gs">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select">
                                            ...
                                            <option value="option_select_designation">Admin</option>
                                            <option value="option_select_designation">Manager</option>
                                            <option value="option_select_designation">Pharmacist</option>
                                            <option value="option_select_designation">Accountant</option>
                                            <option value="option_select_designation">Salesman</option>
                                            <option value="option_select_designation">Cleaner</option>
                                        </select>
                                    </div>
                                </div>
                            </div><!--col-->
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Edit Member</a>
                                    </li>
                                    <li>
