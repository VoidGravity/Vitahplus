...
<head>
    ...
    <!-- Page Title  -->
    <title>Invoice | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                            ...
                                            <div class="card-inner p-0">
                                                <table class="table table-orders">
                                                    ...
                                                    <tbody class="tb-odr-body">
                                                        <tr class="tb-odr-item">
                                                            ...
                                                            <td class="tb-odr-action">
                                                                <div class="tb-odr-btns d-none d-sm-inline">
                                                                    <a href="html/pharmacy/invoice-print.html" target="_blank" class="btn btn-icon btn-white btn-dim btn-sm btn-primary"><em class="icon ni ni-printer-fill"></em></a>
                                                                    <a href="html/pharmacy/invoice-details.html" class="btn btn-dim btn-sm btn-primary">View</a>
                                                                </div>
                                                        ...
                                                        <tr class="tb-odr-item">
                                                            <td class="tb-odr-info">
                                                                <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#326T4M9</a></span>
                                                                <span class="tb-odr-date">21 Jan 2019, 6 :12 am</span>
                                                            </td>
                                                            <td class="tb-odr-amount">
                                                                <span class="tb-odr-total">
