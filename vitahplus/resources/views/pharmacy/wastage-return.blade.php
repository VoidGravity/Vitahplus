...
<head>
    ...
    <!-- Page Title  -->
    <title>Wastage Return | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body ui-rounder npc-default has-sidebar ">
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-2">
                                                        ...
                                                        <li class="nk-block-tools-opt">
                                                            <a href="html/pharmacy/add-wastage-return.html" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                                            <a href="html/pharmacy/add-wastage-return.html" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Wastage Return</span></a>
                                                        </li>
                                                        </li>
                                                    </ul>
                                                </div>
                                                                            ...
                                                                            <li>
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                                                        <div class="dropdown-head">
                                                                                            <span class="sub-title dropdown-title">Filter Wastage Return</span>
                                                                                            <div class="dropdown">
                                                ...
                                                <div class="card-search search-wrap" data-search="search">
                                                    <div class="card-body">
                                                        <div class="search-content">
                                                            ...
                                                            <input type="text" class="form-control border-transparent form-focus-none" placeholder="Search by Purchase id name or">
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl"><span class="sub-text">Seller</span></div>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a data-bs-toggle="modal" href="#editWastageReturn"><em class="icon ni ni-edit"></em><span>Edit Selected</span></a></li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Anim Lio</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="badge  bg-outline-danger">Wrong medication</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>2box</span>
                                                        </div>
                                                            ...
                                                            <ul class="nk-tb-actions gx-1">
                                                                ...
                                                                <li>
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a data-bs-toggle="modal" href="#editWastageReturn"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Robert Omi</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="badge  bg-outline-warning">Wrong dispensing</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>10pcs</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Jimi Tarde</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">12.20 <span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Sturn Vais</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="badge  bg-outline-info">Subsidence of symptoms</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>1box</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Born Myre</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Runi Lara</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">25.50 <span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Sparking Piom</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">33.55 <span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li class="nk-tb-action-hidden">
    ...
    <!-- Edit Wastage Return-->
    <div class="modal fade" tabindex="-1" role="dialog" id="editWastageReturn">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Edit Wastage Return</h5>
