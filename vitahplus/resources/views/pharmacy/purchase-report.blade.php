...
<head>
    ...
    <!-- Page Title  -->
    <title>Purchase report | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body ui-rounder npc-default has-sidebar ">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Purchase Report</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                            <a data-bs-toggle="modal" href="#addPurchase" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                            <a data-bs-toggle="modal" href="#addPurchase" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Purchase</span></a>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Purchase Id</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Manufacturer Name</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#746F5K2</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-10</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#546H74W</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-13</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Square</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#986G531</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-31</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Lupun</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#924GH92</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-62</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Sun</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#165F9K2</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-79</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Medicare</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">62.00 <span class="currency">USD</span></span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-21</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Supportmedi</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>19/12/2020</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">21.00 <span class="currency">USD</span></span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#87X6A44</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-40</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Sunflower</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#846F5K2</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-25</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Oxidin</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">79.00 <span class="currency">USD</span></span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#174K7M5</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-32</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>HeavenLife</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>12/12/2021</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">58.00 <span class="currency">USD</span></span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-odr-id"><a href="html/pharmacy/invoice-details.html">#4S8F5K7</a></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium">#P-52</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Acme</span>
                                                        </div>
    ...
    <!-- app-root @e -->
    <!-- Add Purchase-->
    <div class="modal fade" tabindex="-1" role="dialog" id="addPurchase">
                        ...
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Manufacturer Name" required>
                                </div>
                            </div><!-- .col -->
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Add Purchase</a>
                                    </li>
                                    <li>
