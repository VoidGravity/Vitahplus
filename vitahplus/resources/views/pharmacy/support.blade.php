...
<head>
    ...
    <!-- Page Title  -->
    <title>Support | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                    ...
                                    <div class="nk-block-between">
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <a href="#" class="btn btn-primary" data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em><span>New</span></a>
                                                </li>
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#"><span>Notification Settings</span></a></li>
                                                                <li><a href="#"><span>Message Setting</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="nk-msg-head">
                                            ...
                                            <div class="nk-msg-head-meta">
                                                ...
                                                <ul class="nk-msg-actions">
                                                    ...
                                                    <!-- <li><span class="badge badge-dim bg-success badge-sm"><em class="icon ni ni-check"></em><span>Closed</span></span></li> -->
                                                        ...
                                                        <div class="nk-reply-form-editor">
                                                            ...
                                                            <div class="nk-reply-form-tools">
                                                                <ul class="nk-reply-form-actions g-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="dropdown">
                                                                            <a class="btn btn-icon btn-sm btn-tooltip" data-bs-toggle="dropdown" title="Templates" href="#"><em class="icon ni ni-hash"></em></a>
