...
<head>
    ...
    <!-- Page Title  -->
    <title>Add Member | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Add Member</h3>
                                    ...
                                    <div class="card card-bordered">
                                        <div class="card-inner">
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label" for="nidLabel">National ID</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
                                                                <input type="file" multiple class="form-control" id="nid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!--col-->
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label" for="certificatesLabel">Certificates</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="form-label" for="bio">Short Biography</label>
                                                        <div class="form-control-wrap">
