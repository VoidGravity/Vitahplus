...
<head>
    ...
    <!-- Page Title  -->
    <title>Regular Page v2 | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                        ...
                        <ul class="nk-menu">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="html/components/widgets/ratings.html" class="nk-menu-link"><span class="nk-menu-text">Rating Widgets</span></a>
                                    </li><!-- .nk-menu-item -->
                                </ul><!-- .nk-menu-sub -->
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item has-sub">
                                ...
                                <div class="content-page wide-lg">
                                    ...
                                    <div class="nk-block">
                                        <article class="entry">
                                            ...
                                            <img src="{{asset('images/slides/slide-b.jpg')}}" alt="">
