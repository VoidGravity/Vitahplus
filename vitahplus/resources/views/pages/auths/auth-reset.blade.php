                                ...
                                <div class="nk-block-between">
                                    <ul class="nav nav-sm">
                                        ...
                                        <li class="nav-item dropup">
                                            <a class="dropdown-toggle dropdown-indicator has-indicator link link-primary fw-normal py-2 px-3" data-toggle-body="true" data-bs-toggle="dropdown" data-offset="0,10"><small>English</small></a>
