                                ...
                                <div class="brand-logo pb-5">
                                    <a href="html/index.html" class="logo-link">
                                        <img class="logo-light logo-img logo-img-lg"
                                            src="{{ asset('images/logo.png') }}" srcset="./images/logo2x.png 2x"
                                            alt="logo">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Reset your Evento password</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                <form action="{{ url('password/update') }}" method="POST">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="password" type="password" name="password"
                                                    class="form-control form-control-l" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="password_confirmation">Passcode
                                                    Confirmation</label>

                                                <input id="password_confirmation" type="password"
                                                    name="password_confirmation" class="form-control form-control-l"
                                                    required>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox">I agree to Evento <a
